...
},b=a=d=function(m){function n(s){if("."!==s.charAt(0)){return s}for(var p=s.split("https://www.apple.com/"),t=m.split("https://www.apple.com/").slice(0,-1),o=0,q=p.length;
q>o;o++){var r=p[o];if(".."===r){t.pop()}else{if("."===r){continue}t.push(r)}}return t.join("https://www.apple.com/")
...
}:(g=k(g,c),o(g))});return{deps:a,exports:f,module:d}}function k(d,a){var c,b=a&&a.split("https://www.apple.com/");
if(d&&"."===d.charAt(0)){if(a){for(b.pop(),d=d.split("https://www.apple.com/"),d=b.concat(d),c=0;c<d.length;
c+=1){if("."===d[c]){d.splice(c,1),c-=1}else{if(".."===d[c]){if(1===c&&(".."===d[2]||".."===d[0])){break
}c>0&&(d.splice(c-1,2),c-=2)}}}d=d.join("https://www.apple.com/")}else{0===d.indexOf("https://www.apple.com/contact/")&&(d=d.substring(2))
...
},l.getRegisteredNamespaces=function(){var b=l.getRegisteredModules(),a={};return b.forEach(function(d){var c=d.split("https://www.apple.com/")[0];
...
if(n.Browser.IE){if(n.Browser.IE.documentMode<9){i("https://www.apple.com/contact/ac-base/shims/html5.js")()
...
this.__handleReadyStateChange(b,a);b.open("https://www.apple.com/contact/HEAD",c,true);b.send(null)};f.__handleReadyStateChange=function(a,b){a.onreadystatechange=function(){if(this.readyState===4){if(typeof b==="function"){b(this.status===200)
